...
global.lolkey = '06aef819aecca0490185729d' // PUNYA WAHID  8e66d0934cf741bfd2182c16


/*============== STAFF ==============*/
global.owner = [
  ['6283152910041', 'PyBot', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true]
...
/*============== WATERMARK ==============*/
global.wm = '                「 Py-BOT-V1 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘Py-BOT-V1 ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ Py-BOT-V1 '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By WH-MODS-DEV`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ PyBot x Lanz'
...
/*============== STICKER WM ==============*/
global.stickpack = 'Py-BOT-V1'
global.stickauth = `By ©PyBot x Lanz`
